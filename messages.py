...
KNOWLEDGE_UPDATED_NEEDED_MESSAGE = "We need to update the knowledge files given it is the start of a new month. Please try your inquiry again in about 5 minutes."
